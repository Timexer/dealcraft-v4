...
export function CaseIntake() {
  ...
  return (
    <div className={`min-h-screen bg-background case-bg-${scenario.category}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 flex flex-col lg:flex-row gap-6 dramatic-entrance">
        ...
        >
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" onClick={() => step === 2 ? setStep(1) : setPhase('dashboard')} className="gap-2">
              <ArrowLeft className="h-4 w-4" />
              {step === 2 ? 'Back to Narrative' : 'Back'}
            </Button>
          ...
          <div className="flex items-center gap-2">
            <div className={`h-2 w-8 rounded-full transition-colors duration-300 ${step >= 1 ? 'bg-amber-500' : 'bg-border'}`} />
            <div className={`h-2 w-8 rounded-full transition-colors duration-300 ${step >= 2 ? 'bg-amber-500' : 'bg-border'}`} />
            <span className="text-xs text-muted-foreground ml-2 hidden sm:inline-block">Step {step} of 2</span>
          </div>
        </motion.div>
          ...
          {step === 1 ? (
            ...
            >
                ...
                <div className="space-y-4 pr-2">
                    ...
                    <Card className="bg-card/50 border-border/50">
                      <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-semibold flex items-center gap-2">
                          <FileText className="h-4 w-4 text-amber-500" /> Situation
                        </CardTitle>
                      </CardHeader>
                  ...
                  <motion.div custom={1} variants={sectionVariants} initial="hidden" animate="visible">
                    <Card className="bg-card/50 border-border/50">
                      <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-semibold flex items-center gap-2">
                          <Target className="h-4 w-4 text-red-400" /> Client Demands
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="pt-0">
                  ...
                  <motion.div custom={2} variants={sectionVariants} initial="hidden" animate="visible">
                    <Card className="bg-card/50 border-border/50">
                      <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-semibold flex items-center gap-2">
                          <CheckCircle2 className="h-4 w-4 text-emerald-400" /> Known Facts
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="pt-0">
                        <ul className="space-y-2">
                  ...
                  <motion.div custom={3} variants={sectionVariants} initial="hidden" animate="visible">
                    <Card className="bg-card/50 border-border/50">
                      <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-semibold flex items-center gap-2">
                          <HelpCircle className="h-4 w-4 text-violet-400" /> Missing Information
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="pt-0">
                        <ul className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <motion.div custom={4} variants={sectionVariants} initial="hidden" animate="visible">
                      <Card className="bg-card/50 border-border/50">
                        <CardHeader className="pb-3">
                          <CardTitle className="text-sm font-semibold flex items-center gap-2">
                            <Clock className="h-4 w-4 text-orange-400" /> Time Pressure
                          </CardTitle>
                        </CardHeader>
                        <CardContent className="pt-0">
                          <div className="flex items-center gap-2">
                    ...
                    <motion.div custom={5} variants={sectionVariants} initial="hidden" animate="visible">
                      <Card className="bg-card/50 border-border/50">
                        <CardHeader className="pb-3">
                          <CardTitle className="text-sm font-semibold flex items-center gap-2">
                            <AlertTriangle className="h-4 w-4 text-red-400" /> What&apos;s at Stake
                          </CardTitle>
                        </CardHeader>
                        <CardContent className="pt-0">
                  ...
                  <motion.div custom={6} variants={sectionVariants} initial="hidden" animate="visible">
                    <Card className="bg-card/50 border-border/50">
                      <CardHeader className="pb-3">
                        <CardTitle className="text-sm font-semibold flex items-center gap-2">
                          <Heart className="h-4 w-4 text-pink-400" /> Client Emotional State
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="pt-0">
              ...
              <div className="flex justify-end pt-2">
                <Button onClick={() => setStep(2)} className="bg-amber-600 hover:bg-amber-700 text-white gap-2" size="lg">
                  Next: View Case Analytics <ArrowRight className="h-4 w-4" />
                </Button>
              </div>
            </motion.div>
          ) : (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  size="lg"
                >
                  <CheckCircle2 className="h-5 w-5" /> Accept Case
                </Button>
                <Button
                  variant="outline"
                  ...
                  size="lg"
                >
                  <HelpCircle className="h-5 w-5" /> Request More Info
                </Button>
                <Button
                  variant="ghost"
